      ...
      <form action="{{route('alteraNoticia', $noticia)}}" method="post" class="space-y-8">
        @csrf
          ...
          <div class="sm:col-span-2">
              ...
              <textarea id="conteudo" name= "conteudo" value ="{{$noticia->conteudo }}" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escrever noticia"></textarea>
          </div>
